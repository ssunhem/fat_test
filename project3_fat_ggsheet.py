...
class FatDetectionApp:
    ...
    def process_and_display_image(self, image, index): # ประมวลผลและแสดงภาพ
        image = cv2.resize(image, (100, 100))
        fat_percentage = self.calculate_fat_percentage(image)
        ...
        self.update_fat_label(index, fat_percentage)
        self.delete_buttons[index].lift()
    ...
    def save_results(self):
        ...
        URL = "https://script.google.com/macros/s/AKfycbw65V1aOUSuBXGq7uzs2b4Qzs4sFfMXt6yWOMOjHxldRV7zVprQ0SN_Lh3wOAgzDBm6vg/exec"
        try:
